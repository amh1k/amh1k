...
| ---------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **OpenEverest · MariaDB Provider** | [Enable TLS transport encryption (#46)](https://github.com/openeverest/provider-mariadb/pull/46)                                                                                  | **Merged**        | Implements end-to-end TLS support for standalone and Galera deployments, including provider-to-operator configuration mapping, certificate preservation, CA publication in connection secrets, validation, UI controls, and unit/integration coverage.    |
...
| **OpenEverest · CNCF**             | [Add typed backup and restore state enums (#2933)](https://github.com/openeverest/openeverest/pull/2933)                                                                          | **Merged**        | Strengthens the v2 API contract by adding CRD enum validation and propagating typed backup/restore states through generated OpenAPI schemas, Go clients, CLI code, and TypeScript UI/API-test types.                                                      |
